...
const AlertsPanel = () => {
  ...
  return (
    <div className="flex flex-col gap-6 p-4">
      ...
      <Card className="bg-white border border-cyan-200 shadow-sm">
        <CardHeader className="flex justify-between items-center">
          <div>
            ...
            <CardDescription className="text-sm text-cyan-700">
            ...
            alertasImportantes.map((alert, index) => (
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <Badge
                    className={`text-xs font-semibold ${priorityBadgeStyles[alert.prioridad]}`}
                  >
                    {alert.prioridad}
                  </Badge>
                </div>
      ...
      {/* Resumen de Personal */}
      <Card className="bg-gradient-to-br from-cyan-50 to-cyan-100 border border-cyan-200">
        <CardContent className="flex flex-col gap-4 p-6">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-full bg-cyan-500 text-white flex items-center justify-center">
              <Users className="h-6 w-6" />
            </div>
            <div className="flex flex-col flex-1">
              <h3 className="font-semibold text-cyan-900">Estado del Personal</h3>
              <p className="text-sm text-cyan-700 mt-1">
                Información actualizada del sistema
              </p>
              <div className="flex flex-wrap gap-4 mt-2 text-xs text-cyan-800">
